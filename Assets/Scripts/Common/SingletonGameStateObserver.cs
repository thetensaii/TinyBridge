...
public abstract class SingletonGameStateObserver<T> :  Singleton<T>,IEventHandler where T:Component
{
	public virtual void SubscribeEvents()
	{
        ...
        EventManager.Instance.AddListener<GameLevelsMenuEvent>(GameLevelsMenu);
	...
	public virtual void UnsubscribeEvents()
	{
        ...
        EventManager.Instance.RemoveListener<GameLevelsMenuEvent>(GameLevelsMenu);
    ...
    protected virtual void GameLevelsMenu(GameLevelsMenuEvent e)
    {
    }
